...
CREATE TABLE `prestamo` (
  ...
  `codigo_pelicula_alquilada` int DEFAULT NULL,
  `fecha_prestamo` date DEFAULT NULL,
  `fecha_devolucion` date DEFAULT NULL,
  `estado` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`codigo_prestamo`),
  KEY `cedula_fk` (`cedula_cliente`),
  KEY `codigo_pelicula_fk` (`codigo_pelicula_alquilada`),
...
-- Dump completed on 2021-11-24 18:06:22
